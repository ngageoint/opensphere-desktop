...
public class ExportOptionsPanel extends JFXPanel
{
    ...
    private volatile LayerListView myLayerPicker;
    ...
    public int getMaxZoomLevel()
    {
        ...
        FXUtilities.runAndWait(() -> level.set(myMaxZoomCombo.getSelectionModel().getSelectedItem().intValue()));
        return level.get();
    }
    ...
    private Scene createScene(Collection<? extends DataTypeInfo> dataTypes)
    {
        ...
        myMaxZoomCombo.getSelectionModel().select(zoomLevelOptions.get(zoomLevelOptions.size() - 7));
