...
/**
 * Converts an OGC_100 filter to the application's internal 'Filter' structure.
 */
public class OGC100FilterToDataFilterConverter implements Function<FilterType, Filter>
{
    @Override
    public Filter apply(FilterType ogcFilter)
    {
        Source source = new Source();
        Filter filter = new Filter(null, source);
