...
public class AnnotationModel extends WrappedModel<Placemark>
{
    ...
    protected void updateViewModel(Placemark placemark)
    {
        ...
        {
            ExtendedData extendedData = placemark.getExtendedData();
            myShowTitle.set(ExtendedDataUtils.getBoolean(extendedData, Constants.IS_TITLE, false));
            myShowFieldTitles.set(ExtendedDataUtils.getBoolean(extendedData, Constants.IS_FIELD_TITLE, false));
            myShowDecimalLatLon.set(ExtendedDataUtils.getBoolean(extendedData, Constants.IS_LAT_LON_ID, false));
            myShowDMSLatLon.set(ExtendedDataUtils.getBoolean(extendedData, Constants.IS_DMS_ID, false));
            myShowMGRSLatLon.set(ExtendedDataUtils.getBoolean(extendedData, Constants.IS_MGRS, false));
            myShowAltitude.set(ExtendedDataUtils.getBoolean(extendedData, Constants.IS_SHOW_ALTITUDE, false));
            myShowDescription.set(ExtendedDataUtils.getBoolean(extendedData, Constants.IS_DESC_ID, false));
            myShowDistance.set(ExtendedDataUtils.getBoolean(extendedData, Constants.IS_DISTANCE_ID, true));
            myShowHeading.set(ExtendedDataUtils.getBoolean(extendedData, Constants.IS_HEADING_ID, true));
            myShowVelocity.set(ExtendedDataUtils.getBoolean(extendedData, Constants.IS_VELOCITY_ID, true));
            myShowDuration.set(ExtendedDataUtils.getBoolean(extendedData, Constants.IS_DURATION_ID, true));
            ...
            myShowInTimeline.set(ExtendedDataUtils.getBoolean(extendedData, Constants.IS_SHOW_IN_TIMELINE, true));
            myAnimate.set(ExtendedDataUtils.getBoolean(extendedData, Constants.IS_ANIMATE, true));
        }
        else
        {
        ...
        if (placemark != null && placemark.getExtendedData() != null)
        {
            ...
            myIsBubbleFilled.set(ExtendedDataUtils.getBoolean(extendedData, Constants.IS_BUBBLE_FILLED_ID, true));
            myIsPolygonFilled.set(ExtendedDataUtils.getBoolean(extendedData, Constants.IS_POLYGON_FILLED_ID, false));
        }
        else
        {
