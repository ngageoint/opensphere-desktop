...
import net.opengis.ogc._100t.ComparisonOpsType;
import net.opengis.ogc._100t.LiteralType;
import net.opengis.ogc._100t.LogicOpsType;
import net.opengis.ogc._100t.ObjectFactory;
...
public final class FilterToWFS100Converter
{
    ...
    /**
     * Convert the application filter into an OGC WFS 1.0.0 JAXB class.
     *
     * @param filter the filter to convert
     * @return the JAXB-formatted filter for use with OGC WFS 1.0.0 servers
    ...
    /**
     * Convert an application filter criteria into an OGC WFS 1.0.0 JAXB class.
     *
     * @param crit the criteria to convert
     * @return the JAXB-formatted criteria for use with OGC WFS 1.0.0 servers
     * @throws FilterException thrown for any Filter processing anomalies
     */
     ...
     */
    private static GenericOp convert(PropertyNameType field, Conditional op, String val) throws FilterException
    {
     ...
     * @throws FilterException in case of illegal comparison operator
     */
    private static JAXBElement<? extends ComparisonOpsType> cvtCompare(PropertyNameType field, Conditional op, String val)
    ...
    /**
     * Convert an application filter group into an OGC WFS 1.0.0 JAXB class.
     *
     * @param group the group to convert
     * @return the JAXB-formatted group for use with OGC WFS 1.0.0 servers
     * @throws FilterException thrown for any Filter processing anomalies
     */
    ...
    private FilterToWFS100Converter()
    {
    }
}
