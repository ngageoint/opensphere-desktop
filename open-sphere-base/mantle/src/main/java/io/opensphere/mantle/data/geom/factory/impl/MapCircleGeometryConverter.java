...
public final class MapCircleGeometryConverter extends AbstractGeometryConverter
{
    /**
     * Constructor.
     *
     ...
     */
    public MapCircleGeometryConverter(Toolbox toolbox)
    {
        super(toolbox);
    }
     ...
     */
    public EllipseGeometry convert(MapCircleGeometrySupport geomSupport, long id, DataTypeInfo dti, VisualizationState visState,
            RenderPropertyPool renderPropertyPool)
    {
        ...
        ellipseBuilder.setSemiMajorAxis(geomSupport.getRadius());
        ellipseBuilder.setSemiMinorAxis(geomSupport.getRadius());
     ...
     */
    private PolygonRenderProperties createPolygonRenderProperties(MapCircleGeometrySupport geomSupport,
