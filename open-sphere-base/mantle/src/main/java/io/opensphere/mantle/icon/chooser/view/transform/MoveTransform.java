...
public class MoveTransform extends AbstractTransform
{
     ...
     */
    public MoveTransform(final TransformModel model)
    {
        final Label verticalIcon = FxIcons.createClearIcon(AwesomeIconSolid.ARROWS_ALT_V, Color.WHITE, 16);
        verticalIcon.setAlignment(Pos.CENTER);
        verticalIcon.setMinWidth(25);
        final Label horizontalIcon = FxIcons.createClearIcon(AwesomeIconSolid.ARROWS_ALT_H, Color.WHITE, 16);
        horizontalIcon.setMinWidth(25);
        horizontalIcon.setAlignment(Pos.CENTER);

        final Label recenterHorizontal = FxIcons.createClearIcon(AwesomeIconSolid.TIMES, Color.ORANGERED, 14);
        ...
        final Label recenterVertical = FxIcons.createClearIcon(AwesomeIconSolid.TIMES, Color.ORANGERED, 14);
        ...
        final Slider horizontalMoveSlider = createSlider(model.horizontalMoveProperty(), -100, 100,
                TransformModel.DEFAULT_HORIZONTAL_MOVE);
        final Spinner<Double> horizontalMoveSpinner = createSpinner(model.horizontalMoveProperty(), -100, 100,
                TransformModel.DEFAULT_HORIZONTAL_MOVE);

        final Slider verticalMoveSlider = createSlider(model.verticalMoveProperty(), -100, 100,
                TransformModel.DEFAULT_VERTICAL_MOVE);
        final Spinner<Double> verticalMoveSpinner = createSpinner(model.verticalMoveProperty(), -100, 100,
                TransformModel.DEFAULT_VERTICAL_MOVE);
        ...
        final HBox verticalAdjustBox = new HBox(5, verticalIcon, verticalMoveSlider, verticalMoveSpinner, recenterVertical);
        verticalAdjustBox.setAlignment(Pos.CENTER);
        getChildren().add(verticalAdjustBox);
        final HBox horizontalAdjustBox = new HBox(5, horizontalIcon, horizontalMoveSlider, horizontalMoveSpinner,
                recenterHorizontal);
