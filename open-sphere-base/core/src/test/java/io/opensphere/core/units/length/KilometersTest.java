...
/**
 * Test for {@link Kilometers}.
 */
public class KilometersTest
{
    /**
     * Test {@link Kilometers#clone()}.
     */
    @Test
    public void testClone()
    {
        Length dist = new Kilometers(1.852);
    ...
    {
        Assert.assertTrue(new Kilometers(1.852).equals(new Kilometers(1.852)));
        Assert.assertFalse(new Kilometers(1.852).equals(new Kilometers(1.853)));
        Assert.assertFalse(new Kilometers(1.852).equals(new StatuteMiles(1.)));
    }
    ...
    {
        Assert.assertEquals("2.0 kilometers", new Kilometers(2.).toLongLabelString());
        Assert.assertEquals("1.0 kilometer", new Kilometers(1.).toLongLabelString());
        Assert.assertEquals("0.1 kilometers", new Kilometers(.1).toLongLabelString());
    }
    ...
    {
        Assert.assertEquals("2.0 km", new Kilometers(2.).toShortLabelString());
        Assert.assertEquals("1.0 km", new Kilometers(1.).toShortLabelString());
        Assert.assertEquals("0.1 km", new Kilometers(.1).toShortLabelString());
    }
