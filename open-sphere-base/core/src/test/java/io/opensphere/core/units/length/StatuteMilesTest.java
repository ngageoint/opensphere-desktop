...
/**
 * Test for {@link StatuteMiles}.
 */
public class StatuteMilesTest
{
    /**
     * Test {@link StatuteMiles#clone()}.
     */
    @Test
    public void testClone()
    {
        Length dist = new StatuteMiles(1.);
    ...
    {
        Assert.assertTrue(new StatuteMiles(1.).equals(new StatuteMiles(1.)));
        Assert.assertFalse(new StatuteMiles(1.).equals(new StatuteMiles(2.)));
        Assert.assertFalse(new StatuteMiles(1.).equals(new Feet(5280.)));
    }
    ...
    {
        Assert.assertEquals("2.0 statute miles", new StatuteMiles(2.).toLongLabelString());
        Assert.assertEquals("1.0 statute mile", new StatuteMiles(1.).toLongLabelString());
        Assert.assertEquals("0.1 statute miles", new StatuteMiles(.1).toLongLabelString());
    }
    ...
    {
        Assert.assertEquals("2.0 mi", new StatuteMiles(2.).toShortLabelString());
        Assert.assertEquals("1.0 mi", new StatuteMiles(1.).toShortLabelString());
        Assert.assertEquals("0.1 mi", new StatuteMiles(.1).toShortLabelString());
    }
