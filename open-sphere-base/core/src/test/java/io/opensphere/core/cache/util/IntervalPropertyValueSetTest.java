...
public class IntervalPropertyValueSetTest
{
    ...
    public void testSubtractErrorCase1() throws ParseException
    {
        ...
        Geometry poly1 = wktReader
                .read("POLYGON ((64.55128417884413 30.73247621708865, 63.29411581765459 30.73247621708865, 63.29411581765459 31.55986591864089, "
        ...
        builder.clear(GEOMETRY_DESC);
        Geometry poly2 = wktReader
                .read("POLYGON ((63.69346672053501 31.31496501021435, 64.30895870380434 31.269233542397977, 64.30024972923475 31.213344133075182, "
        ...
        Assert.assertEquals(
                wktReader
                        .read("POLYGON ((64.55128417884413 30.73247621708865, 64.42275063773745 30.73247621708865, 64.44042391158344 30.828931766561226, "
                                + "64.4408655944464 30.828333452359132, 64.52143989004699 30.752322491285277, 64.55128417884413 30.73247621708865))"),
                geomValues.get(0));
        Assert.assertEquals(
                wktReader
                        .read("POLYGON ((63.587169620700045 30.73247621708865, 63.29411581765459 30.73247621708865, 63.29411581765459 31.55986591864089, "
                                + "64.45870405358856 31.55986591864089, 64.40841288399751 31.50432569934371, 64.35253336319998 31.413239984689955, "
    ...
    public void testSubtractErrorCase2() throws ParseException
    {
        ...
        WKTReader wktReader = new WKTReader();
        Geometry poly1 = wktReader
                .read("POLYGON ((39.74014737334169 29.57267172841399, 39.65698127568833 29.56916980952858, 39.53212882282782 29.58282141346952, "
        ...
        builder.clear(GEOMETRY_DESC);
        Geometry poly2 = wktReader
                .read("POLYGON ((39.09796458962061 29.83058853283741, 39.04409144256399 29.90228152435198, 38.99448957800802 30.00292901809895, "
                        + "38.96573931252748 30.10950156238839, 38.95877834867712 30.21877514837864, 38.97389008915079 30.32743337063771, "
                        + "39.01068641079537 30.4321676213116, 39.06811078560724 30.52977836643114, 39.1444627253815 30.61727436651371, "
                        + "39.23744379375319 30.69196660560983, 39.34422455370793 30.75155371406734, 39.4615308470035 30.7941958306088, "
                        + "39.5857468041129 30.81857416037243, 39.71303104550396 30.82393394673173, 39.83944174903064 30.81010917097729, "
