...
{
    /**
     * Test for {@link GeoScreenPolylineGeometry#clone()}.
     */
    @Test
    public void testClone()
    {
        ...
        List<ScreenPosition> vertices = new ArrayList<>();
        vertices.add(new ScreenPosition(0, 0));
        vertices.add(new ScreenPosition(15, 15));
        ...
        GeoScreenPolylineGeometry geom = new GeoScreenPolylineGeometry(builder, renderProperties1, constraints1);

        GeoScreenPolylineGeometry clone = geom.clone();
    ...
    /**
     * Test for
     * {@link GeoScreenPolylineGeometry#derive(io.opensphere.core.geometry.renderproperties.BaseRenderProperties, Constraints)}
     * .
     */
    @Test
    public void testDerive()
    {
        ...
        Assert.assertEquals(geom.isLineSmoothing(), ((GeoScreenPolylineGeometry)derived).isLineSmoothing());
        Assert.assertEquals(geom.getLineType(), ((GeoScreenPolylineGeometry)derived).getLineType());
        Assert.assertEquals(geom.getVertices(), ((GeoScreenPolylineGeometry)derived).getVertices());
        Assert.assertEquals(geom.getAttachment(), ((GeoScreenPolylineGeometry)derived).getAttachment());
