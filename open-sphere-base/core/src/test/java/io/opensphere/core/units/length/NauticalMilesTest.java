...
/**
 * Test for {@link NauticalMiles}.
 */
public class NauticalMilesTest
{
    /**
     * Test {@link NauticalMiles#clone()}.
     */
    @Test
    public void testClone()
    {
        Length dist = new NauticalMiles(1.);
    ...
    public void testCompareTo()
    {
        ...
        Assert.assertTrue(dist.compareTo(new Meters(1853.)) < 0);
        Assert.assertTrue(dist.compareTo(new Meters(1851.)) > 0);
    }
    ...
    {
        Assert.assertTrue(new NauticalMiles(1.).equals(new NauticalMiles(1.)));
        Assert.assertFalse(new NauticalMiles(1.).equals(new NauticalMiles(2.)));
        Assert.assertFalse(new NauticalMiles(1.).equals(new Meters(1852.)));
    }

    /**
     * Test {@link NauticalMiles#fromKilometers(double)}.
     */
    @Test
    public void testFromKilometers()
    {
        Assert.assertEquals(1000., NauticalMiles.fromKilometers(1852.), 0.);
    }
    ...
    /**
     * Test {@link NauticalMiles#toKilometers(double)}.
     */
    @Test
    public void testToKilometers()
    {
        Assert.assertEquals(1., NauticalMiles.toKilometers(1000 / 1852.), 1e-14);
    }
    ...
    {
        Assert.assertEquals("2.0 nautical miles", new NauticalMiles(2.).toLongLabelString());
        Assert.assertEquals("1.0 nautical mile", new NauticalMiles(1.).toLongLabelString());
        Assert.assertEquals("0.1 nautical miles", new NauticalMiles(.1).toLongLabelString());
    }
    ...
    {
        Assert.assertEquals("2.0 nm", new NauticalMiles(2.).toShortLabelString());
        Assert.assertEquals("1.0 nm", new NauticalMiles(1.).toShortLabelString());
        Assert.assertEquals("0.1 nm", new NauticalMiles(.1).toShortLabelString());
    }
