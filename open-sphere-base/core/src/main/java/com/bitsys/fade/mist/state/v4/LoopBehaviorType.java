...
/**
 * <p>
 * Java class for LoopBehaviorType.
 * 
 * <p>
...
public enum LoopBehaviorType
{
    ...
    TAPER_END_SNAP_START("taperEndSnapStart"), @XmlEnumValue("taperEndTaperStart")
    TAPER_END_TAPER_START("taperEndTaperStart"), @XmlEnumValue("snapEndSnapStart")
    SNAP_END_SNAP_START("snapEndSnapStart"), @XmlEnumValue("snapEndTaperStart")
