...
public enum MappingUnits
{
    ...
    @XmlEnumValue("")
    VALUE_1(""), @XmlEnumValue("km")
    VALUE_2("km"), @XmlEnumValue("m")
    VALUE_3("m"), @XmlEnumValue("nmi")
    VALUE_4("nmi"), @XmlEnumValue("mi")
    VALUE_5("mi"), @XmlEnumValue("ft")
    VALUE_6("ft");
