...
public class ObjectFactory {
    ...
    private final static QName _FeatureAction_QNAME = new QName("http://www.bit-sys.com/mist/state/v4", "featureAction");
    private final static QName _FeatureStyleAction_QNAME = new QName("http://www.bit-sys.com/mist/state/v4", "featureStyleAction");
    private final static QName _Action_QNAME = new QName("http://www.bit-sys.com/mist/state/v4", "_Action");
    private final static QName _FeatureActions_QNAME = new QName("http://www.bit-sys.com/state/v4", "featureActions");
    private final static QName _FeatureLabelAction_QNAME = new QName("http://www.bit-sys.com/mist/state/v4", "featureLabelAction");
    ...
    /**
     * Create an instance of {@link FeatureStyleActionType }
     *
     */
    public FeatureStyleActionType createFeatureStyleActionType() {
        return new FeatureStyleActionType();
    }
    ...
    /**
     * Create an instance of {@link FeatureActionType }
     *
     */
    public FeatureActionType createFeatureActionType() {
        return new FeatureActionType();
    }

    /**
     * Create an instance of {@link FeatureLabelActionType }
     *
     */
    public FeatureLabelActionType createFeatureLabelActionType() {
        return new FeatureLabelActionType();
    }
    ...
    /**
     * Create an instance of {@link ActionArrayType }
     *
     */
    public ActionArrayType createActionArrayType() {
        return new ActionArrayType();
    }
    ...
    /**
     * Create an instance of {@link FeatureActionArrayType }
     *
     */
    public FeatureActionArrayType createFeatureActionArrayType() {
        return new FeatureActionArrayType();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link FeatureActionType }{@code >}}
     *
     */
    @XmlElementDecl(namespace = "http://www.bit-sys.com/mist/state/v4", name = "featureAction")
    public JAXBElement<FeatureActionType> createFeatureAction(FeatureActionType value) {
        return new JAXBElement<FeatureActionType>(_FeatureAction_QNAME, FeatureActionType.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link FeatureStyleActionType }{@code >}}
     *
     */
    @XmlElementDecl(namespace = "http://www.bit-sys.com/mist/state/v4", name = "featureStyleAction", substitutionHeadNamespace = "http://www.bit-sys.com/mist/state/v4", substitutionHeadName = "_Action")
    public JAXBElement<FeatureStyleActionType> createFeatureStyleAction(FeatureStyleActionType value) {
        return new JAXBElement<FeatureStyleActionType>(_FeatureStyleAction_QNAME, FeatureStyleActionType.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link AbstractActionType }{@code >}}
     *
     */
    @XmlElementDecl(namespace = "http://www.bit-sys.com/mist/state/v4", name = "_Action")
    public JAXBElement<AbstractActionType> createAction(AbstractActionType value) {
        return new JAXBElement<AbstractActionType>(_Action_QNAME, AbstractActionType.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link FeatureLabelActionType }{@code >}}
     *
     */
    @XmlElementDecl(namespace = "http://www.bit-sys.com/mist/state/v4", name = "featureLabelAction", substitutionHeadNamespace = "http://www.bit-sys.com/mist/state/v4", substitutionHeadName = "_Action")
    public JAXBElement<FeatureLabelActionType> createFeatureLabelAction(FeatureLabelActionType value) {
        return new JAXBElement<FeatureLabelActionType>(_FeatureLabelAction_QNAME, FeatureLabelActionType.class, null, value);
    }
