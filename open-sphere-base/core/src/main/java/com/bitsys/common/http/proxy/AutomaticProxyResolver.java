...
public class AutomaticProxyResolver implements ProxyResolver
{
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AutomaticProxyResolver.class);
    ...
    /**
     * Constructs a new {@linkplain AutomaticProxyResolver} with the given
     * script URL.
     *
    ...
    @Override
    public List<ProxyHostConfig> getProxyServer(final URL destination) throws IOException
    {
