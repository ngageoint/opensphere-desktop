...
public final class ContentType implements Serializable
{
     ...
     */
    public static final ContentType APPLICATION_JSON = new ContentType(org.apache.http.entity.ContentType.APPLICATION_JSON);
     ...
     */
    public static final ContentType APPLICATION_SVG_XML = new ContentType(org.apache.http.entity.ContentType.APPLICATION_SVG_XML);
     ...
     */
    public static final ContentType APPLICATION_XML = new ContentType(org.apache.http.entity.ContentType.APPLICATION_XML);

    /**
     * The application/form-data content type. The character set is ISO-8859-1.
     */
    public static final ContentType MULTIPART_FORM_DATA = new ContentType(org.apache.http.entity.ContentType.MULTIPART_FORM_DATA);

    /**
     * The text/html content type. The character set is ISO-8859-1.
     */
    public static final ContentType TEXT_HTML = new ContentType(org.apache.http.entity.ContentType.TEXT_HTML);

    /**
     * The text/plain content type. The character set is ISO-8859-1.
     */
    public static final ContentType TEXT_PLAIN = new ContentType(org.apache.http.entity.ContentType.TEXT_PLAIN);

    /**
     * The text/xml content type. The character set is ISO-8859-1.
     */
    public static final ContentType TEXT_XML = new ContentType(org.apache.http.entity.ContentType.TEXT_XML);

    /**
     * The *&#47* content type. The character set is <code>null</code>.
     */
    public static final ContentType WILDCARD = new ContentType(org.apache.http.entity.ContentType.WILDCARD);
     ...
     *
     * @param contentType Apache's content type to copy.
     */
     ...
     * @param charset the character set encoding or <code>null</code>.
     */
     ...
     * the internal parameters map if it is not already present in the given
     * map.
     *
     * @param mimeType the MIME type.
     * @param charset the character set encoding or <code>null</code>.
     * @param parameters the mapping of parameters or <code>null</code> if there
     *            are no parameters.
     */
    ContentType(final String mimeType, final Charset charset, final Map<String, String> parameters)
    {
        ...
        // add it first.
        if ((parameters == null || !parameters.containsKey(CHARSET)) && charset != null)
        {
    ...
    /**
     * Returns an unmodifiable map of content-type parameters. The order of
     * these parameters matches the order specified during construction.
     * However, according to RFC 1341, the order does not matter. This map will
     * also contain the {@link #CHARSET charset} parameter if provided.
     *
     ...
     * @param mimeType the MIME type.
     * @param charset the character set encoding or <code>null</code>.
     * @param parameters the parameter map or <code>null</code>.
     * @return the new content type instance.
     */
    public static ContentType create(final String mimeType, final Charset charset, final Map<String, String> parameters)
    {
     ...
     * @throws UnsupportedCharsetException if the specified character set is not
     *             supported.
     */
     ...
     * <code>Content-Type</code> value no validation is performed on the parsed
     * content type.
     *
     * @param contentType the string to parse.
     * @return the new content type instance.
     * @throws ParseException if the string does not appear to represent a valid
    ...
    public static ContentType parse(final String contentType)
    {
        ...
        final HeaderElement[] elements = BasicHeaderValueParser.parseElements(contentType, null);
     ...
     * @throws IllegalArgumentException if the MIME type fails validation.
     */
    public static void validateMimeType(final String mimeType)
    {
        ...
        if (slash < 0)
        {
            throw new IllegalArgumentException("The MIME type, " + mimeType + ", must contain a '/'");
        }
