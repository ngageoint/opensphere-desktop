...
public class InputStreamBodyPart extends AbstractContentBodyPart<InputStream>
{
     ...
     *
     * @param inputStream the input stream that provides the content.
     ...
     * @param fileName the optional file name or <code>null</code>.
     */
    public InputStreamBodyPart(final InputStream inputStream, final ContentType contentType, final String fileName)
    {
