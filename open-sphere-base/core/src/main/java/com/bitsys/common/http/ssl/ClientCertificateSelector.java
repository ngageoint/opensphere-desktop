...
public interface ClientCertificateSelector
{
     ...
     *
     * @param aliases the allowable certificate aliases order with the
     *            most-preferred alias first.
     * @param socket the <code>Socket</code> for which the certificate is
     *            needed.
     * @param keyManager the manager of client certificates.
     ...
     */
    String chooseClientAlias(Collection<String> aliases, Socket socket, X509KeyManager keyManager);
     ...
     * @param aliases the allowable certificate aliases order with the
     *            most-preferred alias first.
     * @param engine the <code>SSLEngine</code> for which the certificate is
     *            needed.
     * @param keyManager the manager of client certificates.
     * @return the chosen alias or <code>null</code> if none were provided or
     *         none could be selected.
     ...
     *      Principal[], SSLEngine)
     */
    String chooseClientAlias(Collection<String> aliases, SSLEngine engine, X509KeyManager keyManager);
}
