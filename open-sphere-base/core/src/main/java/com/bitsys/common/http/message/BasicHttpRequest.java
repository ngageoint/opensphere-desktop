...
public class BasicHttpRequest extends AbstractHttpMessage implements HttpRequest
{
     ...
     *
     * @param uri the requested URI.
     * @param method the HTTP method (e.g. {@link #GET}).
     */
     ...
     * @param uri the requested URI.
     * @param method the HTTP method (e.g. {@link #GET}).
     * @param entity the HTTP entity or <code>null</code>.
     */
    ...
    /**
     * Aborts the request. Using this method is thread-safe as opposed to
     * invoking <code>getAbortable().abort()</code> directly.
     */
    @Override
