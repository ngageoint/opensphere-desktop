...
public class CacheManager
{
    ...
    private final Map<Object, CachedValue> cache = Collections.synchronizedMap(new HashMap<Object, CachedValue>());
     ...
     * associated with a value in cache or the cached value is
     * <code>null</code>.
     *
     * @param key the key into the cache.
