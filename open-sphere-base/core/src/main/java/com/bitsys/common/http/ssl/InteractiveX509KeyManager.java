...
public class InteractiveX509KeyManager extends X509ExtendedKeyManagerDecorator
{
    ...
    */
   public InteractiveX509KeyManager(final X509ExtendedKeyManager keyManager,
                                    final ClientCertificateSelector certificateSelector)
   {
      super(keyManager);
      if (certificateSelector == null)
      {
         throw new IllegalArgumentException(
            "The client certificate selector is null");
      }
                                   ...
                                   final Socket socket)
   {
      final String recommendedAlias =
         super.chooseClientAlias(keyTypes, issuers, socket);
      ...
      final String selectedAlias =
         certificateSelector.chooseClientAlias(aliases, socket, this);
                                         ...
                                         final SSLEngine engine)
   {
      ...
      aliases.addAll(getClientAliases(keyTypes, issuers));
      final String selectedAlias =
         certificateSelector.chooseClientAlias(aliases, engine, this);
      return selectedAlias;
   }
    ...
    *           key type first.
    * @param issuers
    *           the certificate issuer authorities.
