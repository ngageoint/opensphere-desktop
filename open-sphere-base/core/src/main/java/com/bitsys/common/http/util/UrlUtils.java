...
public final class UrlUtils
{
         ...
         catch (final MalformedURLException e)
         {
            ...
            catch (final MalformedURLException e2)
            {
               throw new IllegalArgumentException(
                  "Failed to convert the URL string '" + urlString
   ...
   /**
    * Converts the given URL to a URI. If the built-in {@link URL#toURI()} fails, the URL query
    * parameters are checked for proper encoding.
    *
    * @param url
    *           the URL to convert.
    * @return the resulting URI.
    * @throws IllegalArgumentException
    *            if the given URL cannot be converted to a URI.
    */
   public static URI toUri(final URL url) {
      ...
      try {
         ...
         // If an exception is thrown, attempt encoding the query parameter values.
         try {
            uri =
            ...
            final List<NameValuePair> params =
               URLEncodedUtils.parse(url.getQuery(), Charset.forName("UTF-8"));
            ...
            throw new IllegalArgumentException("Failed to convert the URL '" + url + "' to a URI.",
               e2);
         }
      }
      return uri;
                                  ...
                                  final String value)
   {
      ...
      {
         // In the unlikely event of this exception, throw a runtime exception.
         throw new IllegalArgumentException("Failed to create a URL from '"
            + urlString + "' with '" + name + (value == null ? "" : '=' + value)
            + "'", e);
      }
   }
    ...
    *            if the new URL string is malformed.
    */
   public static URL addParameter(final String urlString, final String name)
      throws MalformedURLException
   {
                                  ...
                                  final String value) throws MalformedURLException
   {
      ...
      catch (final UnsupportedEncodingException e)
      {
         ...
         throw new IllegalStateException("Failed to encode parameter '" + name
            + (value == null ? "" : '=' + value) + "'", e);
      }
   }
}
