...
public class ChainedCredentialsProvider implements CredentialsProvider
{
   ...
   /**
    * The next credentials provider if the {@link #provider first}
    * credentials provider cannot satisfy a request.
    */
    ...
    *           the next provider.
    */
   public ChainedCredentialsProvider(final CredentialsProvider provider,
                                     final CredentialsProvider nextProvider)
   {
