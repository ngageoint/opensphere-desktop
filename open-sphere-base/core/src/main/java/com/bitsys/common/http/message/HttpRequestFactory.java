...
{
    /**
     * A static instance of HttpRequestFactory, to be used in place of
     * construction.
     */
    ...
    /**
     * Creates a <code>DELETE</code> request on the given URI. No additional
     ...
     *
     * @param uri the URI of the request.
     * @param headers the optional HTTP header values to set or
     *            <code>null</code> .
     * @return the new request.
     */
     ...
     * @return the new request.
     */
    public HttpRequest patch(final URI uri, final HttpEntity entity, final Multimap<String, String> headers)
    {
     ...
     * @return the new request.
     */
    public HttpRequest post(final URI uri, final HttpEntity entity, final Multimap<String, String> headers)
    {
     ...
     * @return the new request.
     */
    public HttpRequest put(final URI uri, final HttpEntity entity, final Multimap<String, String> headers)
    {
     ...
     */
    protected HttpRequest createHttpRequest(final URI uri, final String method, final Multimap<String, String> headers)
    {
     ...
     * @return the {@linkplain HttpRequest}.
     */
    protected HttpRequest createHttpRequest(final URI uri, final String method, final HttpEntity entity,
