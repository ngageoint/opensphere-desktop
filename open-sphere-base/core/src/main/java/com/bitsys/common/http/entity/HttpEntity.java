...
public interface HttpEntity
{
    ...
    *
    * @param outputStream
    *           the destination for the entity content.
    * @throws IOException
    *            if an error occurs while writing the content to the output.
    */
    ...
    * @throws IOException
    *            if an error occurs while converting the content to a string.
    */
