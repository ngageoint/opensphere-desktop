...
public class ClearDataOptions
{
     ...
     *
     * @param clearSince the date before which the cache will <i>not</i> be
     *            cleared.
     * @param scope the authentication scope or <code>null</code>.
     */
     ...
     *
     * @param clearSince the date before which the cache will <i>not</i> be
     *            cleared or <code>null</code> to clear for all time.
     */
     ...
     *
     * @param scope the authentication scope or <code>null</code> if data should
     *            be cleared without regard to an authentication scope.
     */
    ...
    /**
     * Returns the authentication scope for which cached data will be cleared.
     * If non-<code>null</code>, only data associated with this scope will be
     * cleared.
     *
     ...
     * cleared.
     *
     * @param clearSavedPasswords indicates if saved passwords should be
     *            cleared.
     */
