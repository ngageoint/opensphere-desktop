...
/**
 * <code>HttpEntityConversionUtils</code> aids in converting between this
 * library's types and the Apache equivalent.
 */
public class HttpEntityConversionUtils
{
    ...
    /**
     * Converts a {@link HttpEntity} to Apache's
     * {@link org.apache.http.HttpEntity HttpEntity}.
     *
    ...
    public static org.apache.http.HttpEntity toApacheEntity(final HttpEntity entity)
    {
        ...
        {
            throw new IllegalArgumentException("Unsupported HttpEntity type: " + entity.getClass().getName());
        }
        return apacheEntity;
    }

    /**
     * Converts this library's <code>StringEntity</code> to the Apache
     * equivalent.
     *
     * @param stringEntity the entity to convert.
    ...
    public static org.apache.http.HttpEntity toApacheEntity(final StringEntity stringEntity)
    {
        ...
        if (contentType != null)
        {
            apacheEntity = new org.apache.http.entity.StringEntity(stringEntity.asString(),
                    org.apache.http.entity.ContentType.create(contentType.getMimeType(), contentType.getCharset()));
        }
        else
        {
            apacheEntity = new org.apache.http.entity.StringEntity(stringEntity.asString(), Charset.defaultCharset());
        }
        return apacheEntity;
    }

    /**
     * Converts this library's <code>InputStreamEntity</code> to the Apache
     * equivalent.
     *
     * @param inputStreamEntity the entity to convert.
     * @return the Apache entity.
     */
    public static org.apache.http.entity.InputStreamEntity toApacheEntity(final InputStreamEntity inputStreamEntity)
    {
        ...
        {
            contentType = org.apache.http.entity.ContentType.create(inputStreamEntity.getContentType().getMimeType(),
                    inputStreamEntity.getContentType().getCharset());
        }
        apacheEntity = new org.apache.http.entity.InputStreamEntity(inputStreamEntity.getContent(), contentLength, contentType);
        return apacheEntity;
    }

    /**
     * Converts this library's <code>MultipartEntity</code> to the Apache
     * equivalent.
     *
     * @param multipartEntity the entity to convert.
     * @return the Apache entity.
     */
     ...
     *
     * @param apacheEntity the entity to convert.
     * @return the converted entity.
     * @throws IOException if the entity's content input stream could not be
     *             created.
     */
    public static HttpEntity fromApacheEntity(final org.apache.http.HttpEntity apacheEntity) throws IOException
    {
        ...
        if (apacheEntity != null)
        {
            ...
            entity = new InputStreamEntity(apacheEntity.getContent(), apacheEntity.getContentLength(), contentType);
