...
public class InputStreamEntity extends AbstractHttpEntity
{
     ...
     *
     * @param inputStream the entity's input stream content.
     */
     ...
     */
    public InputStreamEntity(final InputStream inputStream, final long contentLength, final ContentType contentType)
    {
        super(false);
        content = inputStream;
    ...
    {
        return IOUtils.toString(getContent(), getContentType() == null ? null : getContentType().toString());
    }
}
