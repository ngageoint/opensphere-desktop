...
public interface HttpResponse extends HttpMessage, Closeable
{
     ...
     *
     * @return <code>true</code> if the status code indicates an informational
     *         response.
     */
     ...
     *
     * @return <code>true</code> if the status code indicates a successful
     *         response.
     */
     ...
     *
     * @return <code>true</code> if the status code indicates a redirection
     *         response.
     */
     ...
     *
     * @return <code>true</code> if the status code indicates a client error
     *         response.
     */
     ...
     *
     * @return <code>true</code> if the status code indicates a server error
     *         response.
     */
