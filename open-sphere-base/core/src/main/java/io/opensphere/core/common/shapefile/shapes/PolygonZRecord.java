 ...
 * as a value for M.
 */
public class PolygonZRecord extends PolygonMRecord implements ZMinMax
{
    ...
    public PolygonZRecord(List<Point2D.Double> partPointList, List<Double> zList, List<Double> partMeasurementList)
    {
        this();
    ...
    public boolean parseRecord(ByteBuffer buffer)
    {
        ...
        else if (getShapeType() != ShapeType.POLYGONZ.getValue())
        {
            // Log
            returnValue = false;
        }
