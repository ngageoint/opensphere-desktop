 ...
 * as a value for M.
 */
public class PolyLineMRecord extends PolyLineRecord implements MeasureMinMax
{
    ...
    public PolyLineMRecord(List<Point2D.Double> partPointList, List<Double> partMeasurementList)
    {
        this();
    ...
    public boolean parseRecord(ByteBuffer buffer)
    {
        ...
        else if (getShapeType() != ShapeType.POLYLINEM.getValue())
        {
            // Log
            returnValue = false;
        }
