...
public class PaletteBuilder
{
    ...
    /**
     * Creates an image representing given image {@code src} using
     ...
     *
     * @exception IllegalArgumentException if {@code src} is {@code null}.
     *
     * @exception UnsupportedOperationException if implemented method is unable
     *                to create approximation of {@code src} and
     *                {@code canCreatePalette} returns {@code false}.
     *
    ...
    /**
     * Creates an palette representing colors from given image {@code img}. If
     * number of colors in the given image exceeds maximum palette size closest
     * colors would be merged.
     *
     * @exception IllegalArgumentException if {@code img} is {@code null}.
     *
     * @exception UnsupportedOperationException if implemented method is unable
     *                to create approximation of {@code img} and
     *                {@code canCreatePalette} returns {@code false}.
     *
    ...
    /**
     * Returns {@code true} if PaletteBuilder is able to create palette for
     * given image type.
     *
     * @param type an instance of {@code ImageTypeSpecifier} to be indexed.
     *
     * @return {@code true} if the {@code PaletteBuilder} is likely to be able
     *         to create palette for this image type.
     *
     ...
     *
     * @param image an instance of {@code RenderedImage} to be indexed.
     *
     * @return {@code true} if the {@code PaletteBuilder} is likely to be able
     *         to create palette for this image type.
     *
     * @exception IllegalArgumentException if {@code image} is {@code null}.
     */
        ...
        for (int y = 0; y < h; y++)
        {
            for (int x = 0; x < w; x++)
            {
                ...
                if (transparency != Transparency.OPAQUE && aColor.getAlpha() != 0xff)
                {
                    if (transColor == null)
                    {
                        requiredSize--; // one slot for transparent color
