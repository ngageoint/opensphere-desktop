 ...
 * with it.
 */
public class GeoScreenPolygonGeometry extends PolygonGeometry
{
     ...
     *            <code>null</code>).
     */
    public GeoScreenPolygonGeometry(Builder builder, PolygonRenderProperties renderProperties, Constraints constraints)
    {
     ...
     */
    protected GeoScreenPolygonGeometry(Builder builder, PolygonRenderProperties renderProperties, Constraints constraints,
    ...
    @Override
    public GeoScreenPolygonGeometry clone()
    {
        return (GeoScreenPolygonGeometry)super.clone();
    }
    ...
    public static class Builder extends PolygonGeometry.Builder<ScreenPosition>
    {
        /** Geographic position to which this polyline is attached. */
