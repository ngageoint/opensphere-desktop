...
@XmlSeeAlso({ MultiPolygonType.class, MultiCurveType.class, MultiSurfaceType.class, MultiLineStringType.class,
    MultiGeometryType.class, MultiSolidType.class, MultiPointType.class })
