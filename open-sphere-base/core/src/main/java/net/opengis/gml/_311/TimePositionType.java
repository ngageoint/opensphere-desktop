...
public class TimePositionType
{
     ...
     * dateTime by itself does not allow right-truncation, except for fractions
     * of seconds. When used with non-Gregorian calendars based on years,
     * months, days, the same lexical representation should still be used, with
     * leading zeros added if the year value would otherwise have fewer than
     * four digits.
     * 
     * An ordinal position may be referenced via URI identifying the definition
     * of an ordinal era.
     * 
