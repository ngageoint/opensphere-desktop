...
@XmlSeeAlso({ TimeCalendarEraType.class, TimeOrdinalEraType.class, DefinitionProxyType.class, DictionaryType.class,
    AbstractTimeReferenceSystemType.class, UnitDefinitionType.class, AbstractReferenceSystemBaseType.class,
    EllipsoidBaseType.class, PrimeMeridianBaseType.class, AbstractGeneralOperationParameterType.class,
    CoordinateSystemAxisBaseType.class, AbstractCoordinateOperationBaseType.class, AbstractCoordinateSystemBaseType.class,
