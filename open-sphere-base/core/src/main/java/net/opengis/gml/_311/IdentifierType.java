...
public class IdentifierType
{
     ...
     * normally included to identify or reference a code space within which one
     * or more codes are defined. This code space is often defined by some
     * authority organization, where one organization may define multiple code
     * spaces. The range and format of each Code Space identifier is defined by
     * that code space authority. Information about that code space authority
     * can be included as metaDataProperty elements which are optionally allowed
     * in all CRS objects.
     * 
     * @return possible object is {@link JAXBElement }{@code <}{@link CodeType
     *         }{@code >} {@link JAXBElement }{@code <}{@link CodeType
     *         }{@code >} {@link JAXBElement }{@code <}{@link CodeType
     *         }{@code >} {@link JAXBElement }{@code <}{@link CodeType
     *         }{@code >} {@link JAXBElement }{@code <}{@link CodeType
     *         }{@code >} {@link JAXBElement }{@code <}{@link CodeType
     ...
     *            }{@code <}{@link CodeType }{@code >} {@link JAXBElement
     *            }{@code <}{@link CodeType }{@code >} {@link JAXBElement
     *            }{@code <}{@link CodeType }{@code >} {@link JAXBElement
     *            }{@code <}{@link CodeType }{@code >} {@link JAXBElement
     *            }{@code <}{@link CodeType }{@code >} {@link JAXBElement
