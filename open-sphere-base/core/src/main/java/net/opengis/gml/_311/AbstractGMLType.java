...
@XmlSeeAlso({ FeatureStyleType.class, BagType.class, ArrayType.class, AbstractTimeSliceType.class, AbstractTimeObjectType.class,
    CompositeValueType.class, AbstractStyleType.class, AbstractGeometryType.class, AbstractTopologyType.class,
    BaseStyleDescriptorType.class, AbstractFeatureType.class, DefinitionType.class })
public abstract class AbstractGMLType
{
    ...
    /**
     * Multiple names may be provided. These will often be distinguished by
     * being assigned by different authorities, as indicated by the value of the
     * codeSpace attribute. In an instance document there will usually only be
     * one name per authority.Gets the value of the name property.
     * 
     * <p>
     * This accessor method returns a reference to the live list, not a
     * snapshot. Therefore any modification you make to the returned list will
