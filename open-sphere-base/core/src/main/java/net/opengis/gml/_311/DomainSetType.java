...
@XmlType(name = "DomainSetType", propOrder = { "geometry", "timeObject" })
@XmlSeeAlso({ RectifiedGridDomainType.class, MultiCurveDomainType.class, GridDomainType.class, MultiSolidDomainType.class,
    MultiPointDomainType.class, MultiSurfaceDomainType.class })
