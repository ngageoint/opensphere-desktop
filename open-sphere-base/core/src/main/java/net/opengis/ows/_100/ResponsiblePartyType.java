 ...
 * the server. At least one of IndividualName, OrganisationName, or PositionName
 * shall be included.
 * 
 * <p>
...
@XmlType(name = "ResponsiblePartyType", propOrder = { "individualName", "organisationName", "positionName", "contactInfo",
    "role" })
