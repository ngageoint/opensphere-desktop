...
/**
 * For OWS use in the ServiceProvider section of a service metadata document,
 * the optional organizationName element was removed, since this type is always
 * used with the ProviderName element which provides that information. The
