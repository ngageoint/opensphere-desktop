...
@XmlType(name = "UnNamedDomainType", propOrder = { "allowedValues", "anyValue", "noValues", "valuesReference", "defaultValue",
    "meaning", "dataType", "uom", "referenceSystem", "metadata" })
...
public class UnNamedDomainType
{
    ...
    /**
     * Identifier of unit of measure of this set of values. Should be included
     * then this set of values has units (and not a more complete reference
     * system).
     * 
     * @return possible object is {@link DomainMetadataType }
     * 
    ...
    /**
     * Identifier of reference system used by this set of values. Should be
     * included then this set of values has a reference system (not just units).
     * 
     * @return possible object is {@link DomainMetadataType }
     * 
     */
    ...
    /**
     * Optional unordered list of other metadata about this quantity. A list of
     * required and optional other metadata elements for this quantity should be
