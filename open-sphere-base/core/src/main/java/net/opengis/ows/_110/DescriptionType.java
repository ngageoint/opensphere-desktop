 ...
 * some elements. If the xml:lang attribute is not included in a Title, Abstract
 * or Keyword element, then no language is specified for that element unless
 * specified by another means. All Title, Abstract and Keyword elements in the
 * same Description that share the same xml:lang attribute value represent the
 * description of the parent object in that language. Multiple Title or Abstract
