 ...
 * formats desired by client, with preferred formats listed first. Each response
 * format shall be identified by its MIME type. See AcceptFormats parameter use
