...
/**
 * Request to a service to perform the GetResourceByID operation. This operation
 * allows a client to retrieve one or more identified resources, including
 * datasets and resources that describe datasets or parameters. In this XML
...
public class GetResourceByIdType
{
    ...
    /**
     * Optional reference to the data format to be used for response to this
     * operation request. This element shall be included when multiple output
     * formats are available for the selected resource(s), and the client
     * desires a format other than the specified default, if any.
     * 
