...
public class Operation
{
     ...
     * will appear only once. Gets the value of the dcp property.
     * 
     * <p>
     * This accessor method returns a reference to the live list, not a
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the dcp property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link DCP }
     * 
     * 
     */
    ...
    /**
     * Optional unordered list of additional metadata about this operation and
     * its' implementation. A list of required and optional metadata elements
     * for this operation should be specified in the Implementation
     * Specification for this service. (Informative: This metadata might specify
     * the operation request parameters or provide the XML Schemas for the
     * operation request.) Gets the value of the metadata property.
     * 
     * <p>
     * This accessor method returns a reference to the live list, not a
     * snapshot. Therefore any modification you make to the returned list will
