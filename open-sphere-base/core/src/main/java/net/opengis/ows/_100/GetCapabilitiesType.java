 ...
 * to retrieve service metadata about a specific service instance. In this XML
 * encoding, no "request" parameter is included, since the element name
 * specifies the specific operation. This base type shall be extended by each
 * specific OWS to include the additional required "service" attribute, with the
