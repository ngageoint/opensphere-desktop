...
@XmlType(name = "AbstractStyleSelectorType", propOrder = { "abstractStyleSelectorSimpleExtensionGroup",
    "abstractStyleSelectorObjectExtensionGroup" })
@XmlSeeAlso({ StyleMapType.class, StyleType.class })
public abstract class AbstractStyleSelectorType extends AbstractObjectType
{
     ...
     * <CODE>set</CODE> method for the abstractStyleSelectorSimpleExtensionGroup
     * property.
     * 
     * <p>
    ...
    {
        return ((this.abstractStyleSelectorSimpleExtensionGroup != null)
                && (!this.abstractStyleSelectorSimpleExtensionGroup.isEmpty()));
    }
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the abstractStyleSelectorObjectExtensionGroup
     * property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
    ...
    {
        return ((this.abstractStyleSelectorObjectExtensionGroup != null)
                && (!this.abstractStyleSelectorObjectExtensionGroup.isEmpty()));
    }
