...
@XmlType(name = "BalloonStyleType", propOrder = { "color", "bgColor", "textColor", "text", "displayMode",
    "balloonStyleSimpleExtensionGroup", "balloonStyleObjectExtensionGroup" })
public class BalloonStyleType extends AbstractSubStyleType
{
     ...
     * 
     * @param value allowed object is {@link DisplayModeEnumType }
     * 
     */
     ...
     * <CODE>set</CODE> method for the balloonStyleSimpleExtensionGroup
     * property.
     * 
     * <p>
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the balloonStyleObjectExtensionGroup
     * property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
