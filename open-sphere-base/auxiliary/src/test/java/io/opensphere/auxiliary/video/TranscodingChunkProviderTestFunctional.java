...
/**
 * Tests the {@link TranscodingChunkProvider} class.
 */
public class TranscodingChunkProviderTestFunctional
{
    /**
    ...
    public void testProvideChunksWithMetadata() throws ChunkException, FileNotFoundException
    {
        ...
        try (TranscodingChunkProvider chunkProvider = new TranscodingChunkProvider(fileStream, inputContainer, start, 5000,
                feedName))
        {
            chunkProvider.provideChunks(consumer, contentHandler);
        }

        assertEquals(175, myNumberOfChunks);
    ...
    public void testProvideChunksWithMetadata2() throws ChunkException, FileNotFoundException
    {
        ...
        assertEquals(536, myNumberOfChunks);
