...
"$OPENSPHERE_JAVA" $MAX_MEM_ARG "$OPENSPHERE_PATH_RUNTIME_ARG" -cp override.jar:log4j-1.2.17.jar:core-${project.version}.jar:open-sphere-dark-laf-${project.version}.jar -splash:splash.png io.opensphere.core.launch.Launch
